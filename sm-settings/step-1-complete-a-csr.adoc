...
Wait for the CA to return the certificates, and then go to link:step-3-import-signed-certificates-for-the-controllers.md#[Step 2: Import signed certificates for controllers].
