---
permalink: sm-storage/create-volumes-storage-step-3.html
sidebar: sidebar
keywords: system, manager, suggest, volume, configuration, based, application, workload, select, optimized, support, accept, recommended, edit, needed, manually, specify, characteristics, create
